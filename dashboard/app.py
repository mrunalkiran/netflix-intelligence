...
<style>
    ...
    /* Force sidebar always visible — prevent it from being collapsed */
    section[data-testid="stSidebar"] {
        transform: none !important;
        min-width: 21rem !important;
    }
    /* Hide collapse/expand toggle buttons so users can't accidentally hide it */
...
with st.sidebar:
    ...
    st.markdown(f"""
        ...
        <div style='display:flex;align-items:center;justify-content:center;gap:4px;margin-top:-2.5rem;margin-bottom:4px'>
